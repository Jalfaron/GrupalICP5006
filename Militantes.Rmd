...
tabla_grafico_fix <- tabla_grafico %>%
  mutate(partido = case_match(partido,
    ...
    # Mantenemos el resto igual si ya coinciden
    .default = partido 
  ))
...
tabla_grafico_fix <- tabla_grafico %>%
  mutate(partido = case_match(partido,
    ...
    "RADICAL DE CHILE"   ~ "PARTIDO RADICAL DE CHILE",
    "DEMOCRATA CRISTIANO" ~ "PARTIDO DEMOCRATA CRISTIANO",
    "DE LA GENTE"        ~ "PARTIDO DE LA GENTE",
    "REPUBLICANO DE CHILE" ~ "PARTIDO REPUBLICANO DE CHILE",
    ...
    "REGIONALISTA INDEPENDIENTE DEMOCRATA" ~ "PARTIDO REGIONALISTA INDEPENDIENTE DEMOCRATA"
